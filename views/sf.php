...
if (isset($_POST['ref'])) {
    ...
    $reponse1 = $bdd->query("SELECT * FROM  sf WHERE `ref` Like '$var1' AND designation like '$var2' AND fournisseurId LIKE '$var3' AND categorie_pieceId LIKE '$var4' AND marque_pieceId Like '$var5' ");
}
if (isset($_SESSION['cartt']))
    $n = count($_SESSION['cartt']);
else
    $n = 0;
?>
...
<body>
    ...
    <div id="add_new">
        <div class="col-xl-9 col-lg-10 col-sm-8 col-7">
            <a href="../controller/cart1.php" class="cart position-relative d-inline-flex" aria-label="View your shopping cart">
    ...
    <script>
        ...
        $(".cart").click(function() {
            ...
            var trr = $(tr).val();
            alert(trr);
            $.get("../controller/cart0.php?id=" + window.i + "&q=" + quantite + "&t=" + trr, function(data, status) {
                if (status == 'success') {
                    if (data == 'error') {
